...
<head>
    <meta charset="utf-8">
    <title>Azul - Mise à jour commercial</title>
    <!-- Stylesheets -->
                        ...
                        <table class="form" border="0" cellspacing="0" cellpadding="0">
                            ...
                            if (isset($_POST['id'])) {
                                ...
                                if ($db->query("UPDATE customer_details  SET customer_name='$name',customer_address='$address',customer_contact1='$contact1',customer_contact2='$contact2' where id='$id'"))
                                    echo "<div class='confirmation-box round'>[ $name ] Détails commercial mises à jour !</div>";
                                else
                            ...
                            <form name="form1" method="post" id="form1" action="">
                                ...
                                <tr>
                                    <td>Nom</td>
                                    <td><input name="name" type="text" id="name" readonly="readonly" maxlength="200" class="round default-width-input" onkeypress="return lettersOnly(event)" value="<?php echo $line->customer_name;?>"/></td>
                                    <td><b><span class="man">*</span></b><b>Contact-1</b></td>
                                    <td><input name="contact1" type="text" id="buyingrate" maxlength="20" class="round default-width-input" onkeypress="return numbersonly(event)" value="<?php echo $line->customer_contact1;?>"/></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td><b>Adresse:</b></td>
                                    <td><textarea name="address" cols="15" class="round full-width-textarea"><?php echo $line->customer_address;?></textarea></td>
