...
<div id="header">
    ...
    <div class="page-full-width cf">
        ...
        <a href="#" id="company-branding" class="fr"><img src="upload/posnic.png" alt="Azul Fish"/></a>
...
if (isset($_POST['submit']) and isset($_POST['uname']) and isset($_POST['password']) and isset($_POST['answer'])) {
    ...
    $answer = $_POST['answer'];
    $db->query("UPDATE stock_user  SET username ='" . $uname . "',password='" . md5($password) . "',answer='" . $answer . "'");
