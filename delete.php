...
if (!isset($_SESSION['username']) || $_SESSION['usertype'] != 'admin') { // if session variable "username" does not exist.
    header("location: index.php?msg=Merci%20De%20Vous%20Identifiez%20Pour%20Pouvoir%20Supprimer%20Le%20Listing!"); // Re-direct to index.php
} else {
    ...
    if (isset($_GET['id']) && isset($_GET['table'])) {
        ...
        header("location: $return?msg=Enregistrement supprimé avec succès!&id=$id");
    }
    if (isset($_POST['table']) && isset($_POST['checklist'])) {
        ...
        header("location: $return?msg=Enregistrements supprimés avec succès!");
    }
