...
<head>
    ...
    <title>Impression de Sortie</title>
    ...
    <tr>
        <td align="center" valign="top">
            ...
            <table width="595" cellspacing="0" cellpadding="0" id="bordertable" border="1">
                <tr>
                    <td align="center"><strong>Reçu de Sortie <br/>
                        </strong>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="95%" align="left" valign="top"><br/>
                                    <?php
                                    $line9 = $db->queryUniqueObject("SELECT * FROM sorties WHERE id_sortie='$sid'");
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="18%" bgcolor="#CCCCCC"><strong>Quantité</strong></td>
                            </tr>
