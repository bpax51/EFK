            ...
            <div class="content-module">
                ...
                <div class="content-module-main cf">
                    <table>
                        ...
                        <form action="" method="get" name="limit_go">Lignes par Page<input name="limit" type="text" class="round my_text_box" id="search_limit" style="margin-left:5px;" value="<?php if (isset($_GET['limit'])) echo $_GET['limit']; else echo "10"; ?>" size="3" maxlength="3">
...
-->
                                ...
                                */
                                ...
                                if ($lastpage > 1) {
                                    ...
                                    if ($page > 1)
                                        ...
                                        $pagination .= "<a href=\"view_customers.php?page=$prev&limit=$limit$SearchText\" class=my_pagination >Previous</a>";
...

                                    {
                                        ...
                                        for ($counter = 1; $counter <= $lastpage; $counter++) {
                                            ...
                                            if ($counter == $page)
                                                ...
                                                $pagination .= "<a href=\"view_customers.php?page=$counter&limit=$limit$SearchText\" class=my_pagination>$counter</a>";
...

                                    {
                                        ...
                                        if ($page < 1 + ($adjacents * 2)) {
                                            ...
                                            $pagination .= "<a href=\"view_customers.php?page=$lpm1&limit=$limit$SearchText\" class=my_pagination>$lpm1</a>";

                                            $pagination .= "<a href=\"view_customers.php?page=$lastpage&limit=$limit$SearchText\" class=my_pagination>$lastpage</a>";

                                        } //in middle; hide some front and some back

                                        elseif ($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2)) {

                                            $pagination .= "<a href=\"view_customers.php?page=1&limit=$limit$SearchText\" class=my_pagination>1</a>";

                                            $pagination .= "<a href=\"view_customers.php?page=2&limit=$limit$SearchText\" class=my_pagination>2</a>";
                                    ...
                                    if ($page < $counter - 1)
                                        ...
                                        $pagination .= "<a href=\"view_customers.php?page=$next&limit=$limit$SearchText\" class=my_pagination>Next</a>";
				...
				<table>
                                    ...
                                    <td align='right'style="width:20%"><?php $end=$no+$co1;?>
                                         <?php if($end !=''){?>
                                            Affichage de <?php echo $no+1;?> à <?php echo $end;?> sur <?php echo $total_pages;?> lignes</td><td >&nbsp;</td><td><?php echo $pagination; ?></td>
                                 <?php }else{?>
