...
<head>
    <meta charset="utf-8">
    <title>Azul - Authentification</title>
...
<div id="header">
    ...
    <div class="page-full-width cf">
        ...
        <div id="login-intro" class="fl">
            ...
            <h5>Entrez vos informations d'identification ci-dessous</h5>
...
<div id="content">
    ...
    <form action="checklogin.php" method="POST" id="login-form" class="cmxform" autocomplete="off">
        ...
        <fieldset>
            ...
            <input type="submit" class="button round blue image-right ic-right-arrow" name="submit" value="Entrer"/>
        </fieldset>

        <br/>

        <div class="information-box round">Veuillez entrez vos informations
        </div>
