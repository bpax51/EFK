            ...
            <tr>
                <td align="center">
                    ...
                    <table width="595" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td height="30" align="center" style="font-size:20px;"><strong>Rapport des Entrées</strong></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <table width="300" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="300"><strong>Nombre Total d'entrées uniques: <?php echo $age = $db->queryUniqueValue("SELECT count(*) FROM entries WHERE date BETWEEN '$fromdate' AND '$todate' "); ?></strong></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <?php
                                    $result = $db->query("SELECT e.id_entrie as entry, e.date as date,e.supplier_name as fournisseur,s.stock_name as name, s.quantity as quantity,s.numLot as numLot FROM entries e INNER JOIN stock_entries s ON e.id_entrie=s.stock_id where s.type='entry' AND e.date BETWEEN '$fromdate' AND '$todate'");
                                    while ($line = $db->fetchNextObject($result)) {
                                        ...
                                        <tr>
                                            <td><?php $mysqldate = $line->date;
                                                ...
                                                echo $phpdate; ?></td>
                                            <td><?php echo $line->entry; ?></td>
                                            <td><?php echo $line->fournisseur; ?></td>
