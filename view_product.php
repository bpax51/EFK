...
<!--<input type="button" name="Deleteall" value="Delect All Records"
                                   ...
                                   style="margin-left:5px;" id="cancelall"/>-->
                                    <table>
                                        ...
                                        if (isset($_POST['Search']) AND trim($_POST['searchtxt']) != "") {
                                            $query = "SELECT COUNT(*) as num FROM  stock_details WHERE stock_name LIKE '%" . $_POST['searchtxt'] . "%' OR stock_id LIKE '%" . $_POST['searchtxt'] . "%'";
                                            $SearchText = "&searchtxt=".$_POST['searchtxt'];
                                        }
                                        ...
                                        if (isset($_POST['Search']) AND trim($_POST['searchtxt']) != "") {
                                            ...
                                            $sql = "SELECT * FROM  stock_details WHERE stock_name LIKE '%" . $_POST['searchtxt'] . "%' OR stock_id LIKE '%" . $_POST['searchtxt'] . "%' ORDER BY id DESC LIMIT $start, $limit";
                                        }
                                        if(isset($_GET['searchtxt']) AND trim($_GET['searchtxt']) != "" ){
                                            $sql = "SELECT * FROM  stock_details WHERE stock_name LIKE '%" . $_POST['searchtxt'] . "%' OR stock_id LIKE '%" . $_POST['searchtxt'] . "%' ORDER BY id DESC LIMIT $start, $limit";
                                        }
